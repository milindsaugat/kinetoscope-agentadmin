/* ============================================================
   Component: Toast.jsx
   Description: Toast notification system with emerald theme
   ============================================================ */
  ...
  return (
    <ToastContext.Provider value={addToast}>
      ...
      <div className="kfpl-toast-container">
        {toasts.map(toast => (
          <div key={toast.id} className={`kfpl-toast kfpl-toast--${toast.type}`}>
            <span className="kfpl-toast-icon">{icons[toast.type]}</span>
            <span className="kfpl-toast-message">{toast.message}</span>
            <span className="kfpl-toast-close" onClick={() => removeToast(toast.id)}>
