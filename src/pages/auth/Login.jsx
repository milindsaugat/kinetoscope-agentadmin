/* ============================================================
   Page: Login.jsx
   Description: Agent login with glassmorphism card and 2FA OTP flow
   ============================================================ */
            ...
            <form className="kfpl-login-form" onSubmit={handleOtpSubmit}>
              ...
              <div style={{ display: 'flex', gap: '12px', marginTop: '12px' }}>
                <button
                  ...
                  style={{ flex: 1, background: 'rgba(16, 185, 129, 0.1)', color: 'var(--color-gold)' }}
                  onClick={() => { setStep('credentials'); setOtp(''); setOtpError(''); setMockOtp(''); }}
                  disabled={loading}
                >
                  Back
                </button>
